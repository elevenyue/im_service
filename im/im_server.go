...
var sync_c chan *core.SyncHistory
var group_sync_c chan *core.SyncGroupHistory
...
func init() {
	...
	sync_c = make(chan *core.SyncHistory, 100)
	group_sync_c = make(chan *core.SyncGroupHistory, 100)
}
...
//过滤敏感词
func FilterDirtyWord(msg *core.IMMessage) {
	if filter == nil {
...
func Serve() {
	...
	for _, addr := range config.storage_rpc_addrs {
		...
		dispatcher.AddFunc("SyncMessage", core.SyncMessageInterface)
		dispatcher.AddFunc("SyncGroupMessage", core.SyncGroupMessageInterface)
		dispatcher.AddFunc("SavePeerMessage", core.SavePeerMessageInterface)
		dispatcher.AddFunc("SavePeerGroupMessage", core.SavePeerGroupMessageInterface)
		dispatcher.AddFunc("SaveGroupMessage", core.SaveGroupMessageInterface)
		dispatcher.AddFunc("GetLatestMessage", core.GetLatestMessageInterface)
